 ...
 * You can modify it to use your own callback (for debug purpose).
 */
VoidCallback *addressErrorCB = NULL;
/**
 *  \brief
 ...
 * You can modify it to use your own callback (for debug purpose).
 */
VoidCallback *illegalInstCB = NULL;
/**
 *  \brief
 ...
 * You can modify it to use your own callback (for debug purpose).
 */
VoidCallback *zeroDivideCB = NULL;
/**
 *  \brief
 ...
 * You can modify it to use your own callback (for debug purpose).
 */
VoidCallback *privilegeViolationCB = NULL;
/**
 *  \brief
 ...
 * You can modify it to use your own callback (for debug purpose).
 */
VoidCallback *errorExceptionCB = NULL;
/**
 *  \brief
 ...
 */
VoidCallback *internalVIntCB = NULL;
/**
 *  \brief
 ...
 */
VoidCallback *internalHIntCB = NULL;
/**
 *  \brief
 ...
 */
VoidCallback *internalExtIntCB = NULL;
